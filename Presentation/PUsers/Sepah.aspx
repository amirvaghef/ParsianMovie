<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sepah.aspx.cs" Inherits="PUsers_Sepah" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>::ParsianMovie:: بانک سپه</title>
</head>
<body dir="rtl">
    ...
    <table width="800px" align="center">
        ...
        <tr>
            <td colspan="2" align="right" style="font-size:medium">
                <label style="font-weight:bold"> بانک سپه ایران   </label>به نام  <label style="color:Yellow; font-weight:bold">امیر محسن یوسفی واقف</label><br />
                شماره حساب برای واریز  : <label style="color:Yellow; font-weight:bold">1821300201104</label><br />
                شماره کارت سپه جهت انتقال وجه از طریق خود پرداز : <label style="color:Yellow; font-weight:bold">1821300201104</label><br />
                <br />
            </td>
        </tr>
        <tr>
