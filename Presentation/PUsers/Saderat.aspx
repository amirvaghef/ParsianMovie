<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Saderat.aspx.cs" Inherits="PUsers_Saderat" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>::ParsianMovie:: بانک صادرات</title>
</head>
<body dir="rtl">
    ...
    <table width="800px" align="center">
        ...
        <tr>
            <td colspan="2" align="right" style="font-size:medium">
                <label style="font-weight:bold"> بانک صادرات ایران - سپهر  </label>به نام  <label style="color:Yellow; font-weight:bold">امیر محسن یوسفی واقف</label><br />
                شماره حساب برای واریز  : <label style="color:Yellow; font-weight:bold">0304754587003</label><br />
                شماره کارت سپهر جهت انتقال وجه از طریق خود پرداز : <label style="color:Yellow; font-weight:bold">6037691021897665</label><br />
                <br />
            </td>
        </tr>
        <tr>
