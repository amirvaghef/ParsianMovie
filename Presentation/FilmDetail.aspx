<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilmDetail.aspx.cs" Inherits="FilmDetail" Theme="Space" %>
    ...
    <div align="center" class="body">
        ...
        <asp:Panel runat="server" CssClass="modalPopup2" ID="FilmDetailPopup" style="width:490px;height:auto;padding:10px; text-align:right;">
            <div style="direction:rtl; text-align:center; float:left; width: 120px; z-index: 1" id="layer1">
                ...
                <br />
                <asp:ImageButton ID="EmptyBasket" SkinID="EmptyBasket" runat="server" OnClick="EmptyBasket_Click" PostBackUrl="~/index.aspx"/>
                <asp:ImageButton ID="FullBasket" SkinID="FullBasket" runat="server" Visible="false" OnClick="FullBasket_Click" PostBackUrl="~/index.aspx"/>
                <br />
